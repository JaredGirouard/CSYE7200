...
object Function {
  ...
  def map7[T1, T2, T3, T4, T5, T6, T7, R](t1y: Try[T1], t2y: Try[T2], t3y: Try[T3], t4y: Try[T4], t5y: Try[T5], t6y: Try[T6], t7y: Try[T7])
    ...
    Try(f(t1y.get, t2y.get, t3y.get, t4y.get, t5y.get, t6y.get, t7y.get))
  ...
  def invert3[T1, T2, T3, R](f: T1 => T2 => T3 => R): T3 => T2 => T1 => R = (x:T3)=> (y:T2) => (z:T1) => f(z)(y)(x)
  ...
  def uncurried2[T1, T2, T3, R](f: T1 => T2 => T3 => R): (T1, T2) => T3 => R = (x:T1, y:T2) => (z:T3) => f(x)(y)(z)
  ...
  def uncurried7[T1, T2, T3, T4, T5, T6, T7, T8, R](f: T1 => T2 => T3 => T4 => T5 => T6 => T7 => T8 => R): (T1, T2, T3, T4, T5, T6, T7) => T8 => R =
    (s:T1, t:T2, u:T3, v:T4, w:T5, x:T6, y:T7) => (z:T8) => f(s)(t)(u)(v)(w)(x)(y)(z)
